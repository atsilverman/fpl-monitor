#!/usr/bin/env python3
"""
Check Supabase Monitoring Status
===============================
Quick script to check the status of all monitoring services using Supabase.
"""
...
from services.supabase_monitoring_logger import check_monitoring_status
from datetime import datetime, timezone

def main():
    print(f"🔍 Checking Supabase monitoring status at {datetime.now(timezone.utc).strftime('%Y-%m-%d %H:%M:%S UTC')}")
    print("=" * 60)
